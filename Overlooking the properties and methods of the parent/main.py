# Переопределение атрибутов объетка и класса
# - используется если у дочерного класса отличные свойства
...
class Cat:
    ...
    def __str__(self):
        return '{} {} хвост есть?  {}, пушистость -  {}'.format(self.__class__.__name__, self.name,
                                                                self.has_tail, self.woolliness)
...
# - используется если у порождённого класса должно отличаться поведение
class Robot:
